...
```
Cannot start the 'com.companyname.dalilalhaj' application.
Original error: 'crc64c1fe6d0abd199a4b.MainActivity' or 'com.companyname.dalilalhaj.crc64c1fe6d0abd199a4b.MainActivity' never started.
```

## ROOT CAUSE IDENTIFIED ?
The app crashes immediately on launch with:
```
Abort message: 'No assemblies found in '/data/user/0/com.companyname.dalilalhaj/files/.__override__/x86_64' 
...
// To:
var appPath = Path.Combine(projectRoot, "DalilAlHaj/bin/Release/net10.0-android/com.companyname.dalilalhaj-Signed.apk");
```

Then build the Release APK:
```bash
dotnet build "D:\Ai workspace\Dalil Alhaj\DalilAlHaj\DalilAlHaj.csproj" -f net10.0-android -c Release
```

### Option 2: Disable Fast Deployment for Debug Builds
Add to `DalilAlHaj.csproj`:
```xml
