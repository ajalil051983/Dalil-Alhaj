    ...
    public partial class ContentDetailPage : ContentPage
    {
        ...
        private void UpdateFavoriteButton()
        {
            try
            {
                ...
                {
                    FavoriteButton.Text = isFavorite ? ZadAlhaj.Resources.Localization.AppResources.RemoveFromFavorites : ZadAlhaj.Resources.Localization.AppResources.AddToFavorites;
                }
            }
            catch (Exception ex)
            {
        ...
        private void OnFavoriteClicked(object? sender, EventArgs e)
        {
            try
            {
                ...
                var isFavorite = favoritesService.IsFavorite(subCategory.Id);
                var message = isFavorite ? ZadAlhaj.Resources.Localization.AppResources.AddedToFavorites : ZadAlhaj.Resources.Localization.AppResources.RemovedFromFavorites;
                DisplayAlertAsync("✅", message, ZadAlhaj.Resources.Localization.AppResources.OK);
            }
            catch (Exception ex)
            {
        ...
        private async void OnCopyClicked(object? sender, EventArgs e)
        {
            try
            {
                ...
                await DisplayAlertAsync(ZadAlhaj.Resources.Localization.AppResources.Success, ZadAlhaj.Resources.Localization.AppResources.TextCopied, ZadAlhaj.Resources.Localization.AppResources.OK);
            }
            catch (Exception ex)
            {
                ...
                await DisplayAlertAsync(ZadAlhaj.Resources.Localization.AppResources.Error, $"{ZadAlhaj.Resources.Localization.AppResources.CopyError}: {ex.Message}", ZadAlhaj.Resources.Localization.AppResources.OK);
            }
        }
        ...
        private async void OnShareClicked(object? sender, EventArgs e)
        {
            try
            {
                ...
                {
                    Title = subCategory.Name,
                    Text = $"{subCategory.Name}\n\n{subCategory.Content}\n\n{ZadAlhaj.Resources.Localization.AppResources.FromApp}"
                });
            }
            catch (Exception ex)
            {
                ...
                await DisplayAlertAsync(ZadAlhaj.Resources.Localization.AppResources.Error, $"{ZadAlhaj.Resources.Localization.AppResources.ShareError}: {ex.Message}", ZadAlhaj.Resources.Localization.AppResources.OK);
            }
        }
    }
}
