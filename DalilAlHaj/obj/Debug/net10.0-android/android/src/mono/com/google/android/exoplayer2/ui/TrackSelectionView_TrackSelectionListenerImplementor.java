...
/** @hide */
	...
	static {
		__md_methods = 
			"n_onTrackSelectionChanged:(ZLjava/util/Map;)V:GetOnTrackSelectionChanged_ZLjava_util_Map_Handler:Com.Google.Android.Exoplayer2.UI.TrackSelectionView+ITrackSelectionListenerInvoker, ExoPlayer.UI\n" +
			"";
