...
/** @hide */
	...
	static {
		__md_methods = 
			"n_onAdClicked:()V:GetOnAdClickedHandler:Com.Google.Android.Exoplayer2.Source.Ads.IAdsLoader+IEventListener, ExoPlayer.Core\n" +
			"n_onAdLoadError:(Lcom/google/android/exoplayer2/source/ads/AdsMediaSource$AdLoadException;Lcom/google/android/exoplayer2/upstream/DataSpec;)V:GetOnAdLoadError_Lcom_google_android_exoplayer2_source_ads_AdsMediaSource_AdLoadException_Lcom_google_android_exoplayer2_upstream_DataSpec_Handler:Com.Google.Android.Exoplayer2.Source.Ads.IAdsLoader+IEventListener, ExoPlayer.Core\n" +
			"n_onAdPlaybackState:(Lcom/google/android/exoplayer2/source/ads/AdPlaybackState;)V:GetOnAdPlaybackState_Lcom_google_android_exoplayer2_source_ads_AdPlaybackState_Handler:Com.Google.Android.Exoplayer2.Source.Ads.IAdsLoader+IEventListener, ExoPlayer.Core\n" +
			"n_onAdTapped:()V:GetOnAdTappedHandler:Com.Google.Android.Exoplayer2.Source.Ads.IAdsLoader+IEventListener, ExoPlayer.Core\n" +
			"";
		mono.android.Runtime.register ("Com.Google.Android.Exoplayer2.Source.Ads.IAdsLoader+IEventListenerImplementor, ExoPlayer.Core", AdsLoader_EventListenerImplementor.class, __md_methods);
	}
	...
	public AdsLoader_EventListenerImplementor ()
	{
		...
		if (getClass () == AdsLoader_EventListenerImplementor.class) {
			mono.android.TypeManager.Activate ("Com.Google.Android.Exoplayer2.Source.Ads.IAdsLoader+IEventListenerImplementor, ExoPlayer.Core", "", this, new java.lang.Object[] {  });
		}
	}
