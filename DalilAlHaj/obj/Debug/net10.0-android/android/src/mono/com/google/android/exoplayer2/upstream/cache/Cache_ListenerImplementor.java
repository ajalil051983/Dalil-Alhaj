...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("Com.Google.Android.Exoplayer2.Upstream.Cache.ICache+IListenerImplementor, ExoPlayer.DataSource", Cache_ListenerImplementor.class, __md_methods);
	}
	...
	public Cache_ListenerImplementor ()
	{
		...
		if (getClass () == Cache_ListenerImplementor.class) {
			mono.android.TypeManager.Activate ("Com.Google.Android.Exoplayer2.Upstream.Cache.ICache+IListenerImplementor, ExoPlayer.DataSource", "", this, new java.lang.Object[] {  });
		}
	}
