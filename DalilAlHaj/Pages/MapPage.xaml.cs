...
namespace DalilAlHaj.Pages
{
    public partial class MapPage : ContentPage
    {
        ...
        private MemoryLayer CreatePinLayer()
        {
            ...
            var locations = new[]
            {
                new { Name = DalilAlHaj.Resources.Localization.AppResources.Kaaba, Lat = 21.4225, Lon = 39.8262, Color = "#E74C3C" }, // Red
                new { Name = DalilAlHaj.Resources.Localization.AppResources.Arafat, Lat = 21.3547, Lon = 39.9839, Color = "#3498DB" }, // Blue
                new { Name = DalilAlHaj.Resources.Localization.AppResources.Muzdalifah, Lat = 21.4069, Lon = 39.9375, Color = "#9B59B6" }, // Purple
                new { Name = DalilAlHaj.Resources.Localization.AppResources.Mina, Lat = 21.413052539985806, Lon = 39.89021580688235, Color = "#27AE60" }, // Green
                new { Name = DalilAlHaj.Resources.Localization.AppResources.SafaMarwa, Lat = 21.4233, Lon = 39.8266, Color = "#E67E22" } // Orange
            };
            ...
            var features = locations.Select(location =>
            {
                ...
                // Use colored pin-shaped symbols
