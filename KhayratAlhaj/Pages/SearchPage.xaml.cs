...
#pragma warning restore CS0618
        ...
        private void OnSearchTextChanged(object? sender, TextChangedEventArgs e)
        {
            if (string.IsNullOrWhiteSpace(e.NewTextValue))
            {
                ...
                ResultsLabel.Text = KhayratAlhaj.Resources.Localization.AppResources.SearchPrompt;
            }
        }
        ...
        private void PerformSearch(string query)
        {
            ...
            ResultsLabel.Text = string.Format(KhayratAlhaj.Resources.Localization.AppResources.Results, results.Count);
        }
