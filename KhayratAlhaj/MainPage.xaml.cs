            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(json))
                {
                    ...
                    if (checklist != null)
                    {
                        ...
                        var title = KhayratAlhaj.Resources.Localization.AppResources.ChecklistTitle;
                ...
                if (!isDisposed)
                {
                    try
                    {
                        await DisplayAlertAsync(
                            KhayratAlhaj.Resources.Localization.AppResources.Error, 
                            $"{ex.Message}", 
